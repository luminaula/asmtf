...
#define ASMTF_THREAD_LOAD_TASK(task) \
        ASMTF_THREAD_LOAD_REGISTER(REGISTER_RDI, task);\
        ASMTF_THREAD_LOAD_REGISTER(REGISTER_RSI, task);\
        ASMTF_THREAD_LOAD_REGISTER(REGISTER_RDX, task);\
        ASMTF_THREAD_LOAD_REGISTER(REGISTER_RCX, task);\
        ASMTF_THREAD_LOAD_REGISTER(REGISTER_R8, task);\
        ASMTF_THREAD_LOAD_REGISTER(REGISTER_R9, task)
